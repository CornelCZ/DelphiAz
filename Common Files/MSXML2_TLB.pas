...
// File generated on 14/08/2018 17:38:43 from Type Library described below.
...
// *********************************************************************//
  DOMDocument60 = IXMLDOMDocument2;
  FreeThreadedDOMDocument60 = IXMLDOMDocument2;
  ...
  ServerXMLHTTP60 = IServerXMLHTTPRequest;
...
{$ENDIF}
  ...
  public
    ...
    function getDeclaration(const node: IXMLDOMNode): ISchemaElement;
...
class function CoDOMDocument60.Create: IXMLDOMDocument2;
begin
  Result := CreateComObject(CLASS_DOMDocument60) as IXMLDOMDocument2;
end;

class function CoDOMDocument60.CreateRemote(const MachineName: string): IXMLDOMDocument2;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_DOMDocument60) as IXMLDOMDocument2;
end;
...
procedure TDOMDocument60.ConnectTo(svrIntf: IXMLDOMDocument2);
begin
  Disconnect;
  FIntf := svrIntf;
  ConnectEvents(FIntf);
...
function TDOMDocument60.GetDefaultInterface: IXMLDOMDocument2;
begin
  if FIntf = nil then
    Connect;
...
function TDOMDocument60.Get_namespaces: IXMLDOMSchemaCollection;
begin
    Result := DefaultInterface.namespaces;
end;

function TDOMDocument60.Get_schemas: OleVariant;
var
...
procedure TDOMDocument60._Set_schemas(otherCollection: OleVariant);
...
function TDOMDocument60.validate: IXMLDOMParseError;
begin
  Result := DefaultInterface.validate;
end;

procedure TDOMDocument60.setProperty(const name: WideString; value: OleVariant);
begin
  DefaultInterface.setProperty(name, value);
end;

function TDOMDocument60.getProperty(const name: WideString): OleVariant;
begin
...
function TDOMDocument60Properties.GetDefaultInterface: IXMLDOMDocument2;
begin
  Result := FServer.DefaultInterface;
end;

function TDOMDocument60Properties.Get_namespaces: IXMLDOMSchemaCollection;
begin
    Result := DefaultInterface.namespaces;
end;

function TDOMDocument60Properties.Get_schemas: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
procedure TDOMDocument60Properties._Set_schemas(otherCollection: OleVariant);
  { Warning: The property schemas has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
...
class function CoFreeThreadedDOMDocument60.Create: IXMLDOMDocument2;
begin
  Result := CreateComObject(CLASS_FreeThreadedDOMDocument60) as IXMLDOMDocument2;
end;

class function CoFreeThreadedDOMDocument60.CreateRemote(const MachineName: string): IXMLDOMDocument2;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_FreeThreadedDOMDocument60) as IXMLDOMDocument2;
end;
...
procedure TFreeThreadedDOMDocument60.ConnectTo(svrIntf: IXMLDOMDocument2);
begin
  Disconnect;
  FIntf := svrIntf;
  ConnectEvents(FIntf);
...
function TFreeThreadedDOMDocument60.GetDefaultInterface: IXMLDOMDocument2;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call ''Connect'' or ''ConnectTo'' before this operation');
...
function TFreeThreadedDOMDocument60.Get_namespaces: IXMLDOMSchemaCollection;
begin
    Result := DefaultInterface.namespaces;
end;

function TFreeThreadedDOMDocument60.Get_schemas: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
procedure TFreeThreadedDOMDocument60._Set_schemas(otherCollection: OleVariant);
  { Warning: The property schemas has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
...
function TFreeThreadedDOMDocument60.validate: IXMLDOMParseError;
begin
  Result := DefaultInterface.validate;
end;

procedure TFreeThreadedDOMDocument60.setProperty(const name: WideString; value: OleVariant);
begin
  DefaultInterface.setProperty(name, value);
end;

function TFreeThreadedDOMDocument60.getProperty(const name: WideString): OleVariant;
begin
  Result := DefaultInterface.getProperty(name);
end;
...
function TFreeThreadedDOMDocument60Properties.GetDefaultInterface: IXMLDOMDocument2;
begin
  Result := FServer.DefaultInterface;
end;

function TFreeThreadedDOMDocument60Properties.Get_namespaces: IXMLDOMSchemaCollection;
begin
    Result := DefaultInterface.namespaces;
end;

function TFreeThreadedDOMDocument60Properties.Get_schemas: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
procedure TFreeThreadedDOMDocument60Properties._Set_schemas(otherCollection: OleVariant);
  { Warning: The property schemas has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
...
function TXMLSchemaCache60.getDeclaration(const node: IXMLDOMNode): ISchemaElement;
begin
...
class function CoServerXMLHTTP60.Create: IServerXMLHTTPRequest;
begin
  Result := CreateComObject(CLASS_ServerXMLHTTP60) as IServerXMLHTTPRequest;
end;

class function CoServerXMLHTTP60.CreateRemote(const MachineName: string): IServerXMLHTTPRequest;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_ServerXMLHTTP60) as IServerXMLHTTPRequest;
end;
...
procedure TServerXMLHTTP60.ConnectTo(svrIntf: IServerXMLHTTPRequest);
begin
  Disconnect;
  FIntf := svrIntf;
end;
...
function TServerXMLHTTP60.GetDefaultInterface: IServerXMLHTTPRequest;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call ''Connect'' or ''ConnectTo'' before this operation');
...
function TServerXMLHTTP60Properties.GetDefaultInterface: IServerXMLHTTPRequest;
begin
  Result := FServer.DefaultInterface;
end;
