unit Serial5;
{
   ...
   Change History :
	...
	3.23	     10/04/98	 Delphi 3 version
        4.23         12/11/98    Delphi 4 version
        4.24         17/11/98    Fixed integer compare to 'INVALID HANDLE' constant
}
...
{$ifdef SHAREWARE}
   ...
   MessageDlg ('SERIAL component for Delphi 4 (c) R J Crowther 1995-1998'+Chr(13)+
               'Shareware version 4.23'+Chr(13)+
