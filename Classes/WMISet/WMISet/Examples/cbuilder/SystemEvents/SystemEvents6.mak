...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = SystemEvents6.exe
OBJFILES = SystemEvents6.obj FrmEventsMainU.obj FrmNewHostU.obj FrmAboutU.obj \
    ..\..\..\WmiSystemEvents.obj
RESFILES = SystemEvents6.res
MAINSOURCE = SystemEvents6.cpp
RESDEPEN = $(RESFILES) FrmEventsMainU.dfm FrmNewHostU.dfm FrmAboutU.dfm
LIBFILES = 
IDLFILES = 
IDLGENFILES = 
LIBRARIES = bcb2kaxserver.lib indy.lib dbxcds.lib dclocx.lib soaprtl.lib bcbie.lib \
    ...
    bdertl.lib adortl.lib vcldb.lib dbrtl.lib VclCommonDcl60.lib wmirtl60.lib \
    rtl.lib vcl.lib
PACKAGES = vcl.bpi rtl.bpi dbrtl.bpi adortl.bpi vcldb.bpi vclx.bpi bdertl.bpi \
    ...
    indy.bpi bcb2kaxserver.bpi VclCommonDcl60.bpi
SPARELIBS = vcl.lib rtl.lib wmirtl60.lib VclCommonDcl60.lib dbrtl.lib vcldb.lib \
    adortl.lib bdertl.lib vcldbx.lib ibxpress.lib cds.lib bdecds.lib qrpt.lib \
    teeui.lib teedb.lib tee.lib dss.lib teeqr.lib visualdbclx.lib \
...
INCLUDEPATH = ..\..\..;..\..\..\..\common;"g:\Program Files\Borland\CBuilder6\Projects";E:\work\gca\Delphi\vcl\wmiset\examples\cbuilder\SystemEvents;$(BCB)\include;$(BCB)\include\vcl
LIBPATH = ..\..\..;..\..\..\..\common;"g:\Program Files\Borland\CBuilder6\Projects";E:\work\gca\Delphi\vcl\wmiset\examples\cbuilder\SystemEvents;$(BCB)\lib\obj;$(BCB)\lib
WARNINGS= -w-par
PATHCPP = .;
PATHASM = .;
PATHPAS = .;..\..\..
...
CFLAG1 = -Od -H=$(BCB)\lib\vcl60.csm -Hc -Vx -Ve -X- -r- -a8 -b- -k -y -v -vi- -c \
    -tW -tWM
IDLCFLAGS = -I..\..\.. -I..\..\..\..\common \
    -I"g:\Program Files\Borland\CBuilder6\Projects" \
    -IE:\work\gca\Delphi\vcl\wmiset\examples\cbuilder\SystemEvents \
