...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = wmirtl60.bpl
OBJFILES = wmirtl60.obj WmiProcessControl.obj WmiStorageInfo.obj \
    WmiDiskQuotaControl.obj WmiConnection.obj WmiDataSet.obj \
    WmiRegistry.obj WmiOs.obj WmiSystemEvents.obj WmiMethod.obj
RESFILES = wmirtl60.res WmiProcessControl.dcr WmiStorageInfo.dcr \
    WmiDiskQuotaControl.dcr WmiConnection.dcr WmiDataSet.dcr WmiRegistry.dcr \
    WmiOs.dcr WmiSystemEvents.dcr WmiMethod.dcr
MAINSOURCE = wmirtl60.cpp
RESDEPEN = $(RESFILES)
LIBFILES = 
IDLFILES = 
IDLGENFILES = 
LIBRARIES = dclocx.lib bcbsmp.lib
PACKAGES = rtl.bpi dbrtl.bpi VclCommonDcl60.bpi vcl.bpi
SPARELIBS = rtl.lib dbrtl.lib bcbsmp.lib dclocx.lib 
DEFFILE = 
OTHERFILES = 
# ---------------------------------------------------------------------------
...
INCLUDEPATH = $(BCB)\include;$(BCB)\include\vcl;..\common
LIBPATH = $(BCB)\Projects\Lib;..\common;$(BCB)\lib\obj;$(BCB)\lib
WARNINGS= -w-par
PATHCPP = .;
PATHASM = .;
PATHPAS = .;
